...
#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_X  22.3          // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X  0.8f       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  18.5          // (Hz) The default dominant resonant frequency on the Y axis.
    #define SHAPING_ZETA_Y  0.8f       // Damping ratio of the Y axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
 ...
 */
//#define PWM_MOTOR_CURRENT { 600, 600, 650 }          // Values in milliamps
 ...
 */
  ...
  //#define MONITOR_DRIVER_STATUS
    ...
    #define CURRENT_STEP_DOWN     400  // [mA]
